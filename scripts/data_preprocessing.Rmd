...
company_key <- as.list(setNames(seq(1, length(unique(data_sheet_company$company_name)), 1), rep("key", length(unique(data_sheet_company$company_name)))))
company_name <- as.list(setNames(unique(data_sheet_company$company_name), rep("text", length(unique(data_sheet_company$company_name)))))
...
write.csv(data_sheet_company, "data_sheet_company.csv")

##################################################################################
### Energy usage by fuel type (including electricity) for each company per year###
##################################################################################
