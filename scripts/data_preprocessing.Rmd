...
for (year_count in 2007:2020) {
  ...
  # create a sub data frame that is filtered by data year and company wide scope
  ...
  # create a sub data frame that is filtered by data year and report exists/no data
...
# drop all the excess rows that have blank data
