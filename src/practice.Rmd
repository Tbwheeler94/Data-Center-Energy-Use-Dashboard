...
data_sheet_graph_2 <- data_sheet %>% 
  ...
  select("company", "data_year", "scope_display_label", "total_energy_use") %>% 
...
```{r}
# Stacked
ggplot(data_sheet_graph_1, aes(fill=fuel_type, y=value, x=data_year)) + 
    geom_bar(position="stack", stat="identity")

```

```{r}
ggplot(data_sheet_graph_2, aes(fill=scope_display_label, y=total_energy_use, x=data_year)) + 
    geom_bar(position="stack", stat="identity")
```
