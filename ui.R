  ...
  div(
    ...
    Grid(
      ...
      div(style = "display: flex; flex-direction: row; justify-content: flex-end; flex-wrap: wrap; gap: 15px; padding-right: 10px;",
          ...
          downloadLink("download_transparency_data", PrimaryButton.shinyInput("fdtrd", iconProps = list("iconName" = "Download"), text = "Download Data")),
  ...
  div(Stack(style = "text-align: center; padding: 25px", Text("Annual Reported Energy Use By Year Across Reporting Companies", variant = "xxLarge", style = "color: #137AD1;")),
      Grid(id = 'energy-data-trends-plot',
        ...
        div(style = "display: flex; flex-direction: row; justify-content: flex-end; flex-wrap: wrap; gap: 15px; padding-right: 10px;",
          ...
          downloadLink("download_energy_data", PrimaryButton.shinyInput("fdedtd", iconProps = list("iconName" = "Download"), text = "Download Data")),
  ...
  div(
    ...
    Grid(
      ...
      div(style = "display: flex; flex-direction: row; justify-content: flex-end; flex-wrap: wrap; gap: 15px; padding-right: 10px;",
          ...
          downloadLink("download_timeline_data", PrimaryButton.shinyInput("fdtid", iconProps = list("iconName" = "Download"), text = "Download Data")),
  ...
  div(
    ...
    Grid(
      ...
      div(style = "display: flex; flex-direction: row; justify-content: flex-end; flex-wrap: wrap; gap: 15px; padding-right: 10px;",
        ...
        downloadLink("download_pue_data", PrimaryButton.shinyInput("fdpued", iconProps = list("iconName" = "Download"), text = "Download Data")),
